...
description: Complete guide to integrating Polygon (POL) with SwapKit SDK for Layer 2 scaling and DeFi operations
---
...
```typescript
// @noErrorValidation
import { getPolygonToolbox } from '@swapkit/toolboxes/evm';
