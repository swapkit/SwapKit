...
description: Complete guide to integrating Radix DLT with SwapKit SDK for XRD operations and DeFi applications
---
...
```typescript
// @noErrorValidation
import { getRadixToolbox } from '@swapkit/toolboxes/radix';
