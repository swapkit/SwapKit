...
description: Complete guide to integrating Bitcoin Cash with SwapKit SDK for UTXO operations and cross-chain swaps
---
...
```typescript
// @noErrorValidation
import { getBitcoinCashToolbox } from '@swapkit/toolboxes/utxo';
