...
description: Complete guide to integrating Optimism with SwapKit SDK for Layer 2 scaling and DeFi operations
---
...
```typescript
// @noErrorValidation
import { getOptimismToolbox } from '@swapkit/toolboxes/evm';
