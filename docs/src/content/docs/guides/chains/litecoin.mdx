...
description: Complete guide to integrating Litecoin with SwapKit SDK for UTXO operations and cross-chain swaps
---
...
```typescript
// @noErrorValidation
import { getLitecoinToolbox } from '@swapkit/toolboxes/utxo';
