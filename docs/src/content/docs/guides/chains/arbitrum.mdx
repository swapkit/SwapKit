...
description: Complete guide to integrating Arbitrum One with SwapKit SDK for Layer 2 DeFi and cross-chain operations
---
...
```typescript
// @noErrorValidation
import { getArbitrumToolbox } from '@swapkit/toolboxes/evm';
