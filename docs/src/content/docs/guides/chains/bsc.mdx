...
description: Complete guide to integrating BNB Smart Chain with SwapKit SDK for DeFi operations and cross-chain swaps
---
...
```typescript
// @noErrorValidation
import { getBSCToolbox } from '@swapkit/toolboxes/evm';
