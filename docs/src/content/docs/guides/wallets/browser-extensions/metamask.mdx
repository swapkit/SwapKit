...
description: Complete guide to integrating MetaMask and EVM browser extensions with SwapKit SDK v4
---
...
- **Brave Wallet**: Built into Brave browser
- **Coinbase Wallet**: [Chrome Web Store](https://chrome.google.com/webstore/detail/coinbase-wallet/hnfanknocfeofbddgcijnmhnfnkdnaad)
- **Trust Wallet**: [Chrome Web Store](https://chrome.google.com/webstore/detail/trust-wallet/egjidjbpglichdcondbcbdnbeeppgdph)
