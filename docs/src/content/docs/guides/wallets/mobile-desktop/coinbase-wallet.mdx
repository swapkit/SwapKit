...
1. Install from [Chrome Web Store](https://chrome.google.com/webstore/detail/coinbase-wallet/hnfanknocfeofbddgcijnmhnfnkdnaad)
...
import { SwapKit, coinbaseWallet, Chain } from "@swapkit/sdk";
...
import { SwapKit, coinbaseWallet, Chain, AssetValue } from "@swapKit/sdk";
...
import { SwapKit, coinbaseWallet, evmWallet, Chain, WalletOption } from "@swapkit/sdk";
