---
title: Security
description: Comprehensive security guide for SwapKit applications including private key management, secure transaction signing, and production best practices
---
...
<Tabs>
  ...
  <TabItem label="Environment Setup">
    ...
    export function configureSecurely() {
      ...
      const requiredEnvVars = ['SWAPKIT_API_KEY'];
...
- Optimize [Performance](/guides/performance) without compromising security
