...
<Tabs syncKey="package-manager">
  <TabItem label="bun" icon="bun">
    ```bash bun add @swapkit/sdk node-polyfill-webpack-plugin ```
  </TabItem>
  <TabItem label="pnpm">
    ```bash pnpm add @swapkit/sdk node-polyfill-webpack-plugin ```
  </TabItem>
  <TabItem label="npm">
    ```bash npm install @swapkit/sdk node-polyfill-webpack-plugin ```
  </TabItem>
  <TabItem label="yarn">
    ```bash yarn add @swapkit/sdk node-polyfill-webpack-plugin ```
  </TabItem>
</Tabs>
...
<Tabs syncKey="package-manager">
  <TabItem label="bun" icon="bun">
    ```bash bun add buffer crypto-browserify stream-browserify stream-http
    https-browserify os-browserify path-browserify ```
  </TabItem>
  <TabItem label="pnpm">
    ```bash pnpm add buffer crypto-browserify stream-browserify stream-http
    https-browserify os-browserify path-browserify ```
  </TabItem>
  <TabItem label="npm">
    ```bash npm install buffer crypto-browserify stream-browserify stream-http
    https-browserify os-browserify path-browserify ```
  </TabItem>
  <TabItem label="yarn">
    ```bash yarn add buffer crypto-browserify stream-browserify stream-http
    https-browserify os-browserify path-browserify ```
  </TabItem>
</Tabs>
