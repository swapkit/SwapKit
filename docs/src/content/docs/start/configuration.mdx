...
const swapKit = createSwapKit({
  config: {
    apiKeys: {
      ...
      blockchair: import.meta.env.BLOCKCHAIR_API_KEY,
      swapKit: import.meta.env.SWAPKIT_API_KEY
    }
  }
});
```
...
const config = {
  ...
  envs: {
    ...
    isStagenet: import.meta.env.USE_TESTNET === 'true'
  },

  // Custom RPC URLs for better performance
  rpcUrls: {
    [Chain.Ethereum]: import.meta.env.ETH_RPC_URL || 'https://eth.llamarpc.com',
    [Chain.Avalanche]: import.meta.env.AVAX_RPC_URL || 'https://api.avax.network/ext/bc/C/rpc',
    [Chain.BinanceSmartChain]: import.meta.env.BSC_RPC_URL || 'https://bsc-dataseed.binance.org'
  }
};
...
if (userHasRadixWallet) {
  SKConfig.setIntegrationConfig('radix', {
    dAppDefinitionAddress: import.meta.env.RADIX_DAPP_ADDRESS!,
