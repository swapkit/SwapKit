...
const App = () => {
  ...
  const [keys, setKeys] = useState({
    ...
    xamanApiKey: import.meta.env.VITE_XAMAN_API_KEY || "0073f779-98f8-4378-af87-c935d2b01f48",
    xamanApiSecret: import.meta.env.VITE_XAMAN_API_SECRET || "4b9eb972-4452-4284-a6bf-d20f47c40533",
